...
export function TestimonialsSection() {
  ...
  const validTestimonials = testimonials.filter(({ name, text, before, discovery, after, rating }) => name?.trim() && (text?.trim() || before?.trim() || discovery?.trim() || after?.trim()) && Number.isFinite(rating))
